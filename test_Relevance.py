...
# CPU Test
model = BertForSequenceRelevance.from_pretrained("../Pretrained/", state_dict=model_state_dict, device="cpu")
model.eval()
...
# GPU Test
model = BertForSequenceRelevance.from_pretrained("../Pretrained/", state_dict=model_state_dict, device="cuda")
model.to("cuda")
model.eval()
